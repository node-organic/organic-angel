describe("wierd use cases", function(){
  ...
  it("invoke only matching by placeholder count", function(next){
    ...
    instance.plasma.on("ready", function(){
      instance.on("test :arg1 :arg2 :arg3", function(options, next){
        next(new Error("should not happen"))
      })
      instance.on("test :arg1 :arg2 :arg3 :arg4", function(options, next){
        next(null, options)
      })
  ...
  it("invoke by placeholder count with optionals", function(next){
    instance = new Angel()
    instance.plasma.on("ready", function(){
      instance.on("test :arg1 :arg2 :arg3(a|b)?", function(options, next){
        next(new Error("should not happen"))
      })
      instance.on("test :arg1 :arg2 :arg3 :arg4(a|b)?", function(options, next){
        next(null, options)
      })
